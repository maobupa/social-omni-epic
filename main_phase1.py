...
Run from the social-omni-epic/ directory:
  python main_phase1.py run_mode=phase0
...
@hydra.main(
    version_base=None, config_path="configs", config_name="social_omni_epic_phase1"
)
